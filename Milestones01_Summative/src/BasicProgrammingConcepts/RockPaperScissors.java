...
public class RockPaperScissors {
    ...
    /* ROCK, PAPER, AND SCISSOR METHODS
    public static void rock(int choice) {
        choice = 1;
        int userWin = 0;
        int compWin = 0;
        int tie = 0;

        int compChoice = compRockPaperScissor();
        // System.out.println(compChoice);
        if (compChoice == 1) {
            System.out.println("We've Tied!");
            tie++;
    ...
    public static void paper(int choice) {
        choice = 2;
        int userWin = 0;
        int compWin = 0;
        int tie = 0;
    ...
    public static void scissors(int choice) {
