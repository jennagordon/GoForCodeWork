...
public class SightingServiceImplTest {
    ...
    public void removeSighting() {
        ...
        // Act
        sightingService.removeSighting(createdSighting);
        Sighting readSighting = sightingService.retrieveSighting(createdSighting.getSightingId());
    ...
    public void updateSighting() {
        ...
        // Act
        sightingService.updateSighting(readSighting);
    ...
    public void retrieveAllSightings() {
        ...
        // Act
        List<Sighting> sightingList = sightingService.retrieveAllSightings(Integer.MAX_VALUE, 0);
    ...
    public void retrieveSightingByHeroPage() {
        ...
        // Act
        List<Sighting> sightingList = sightingService.retrieveSightingByHero(hero, 2, 0);
    ...
    public void retrieveSightingByLocationPage() {
        ...
        // Act
        // return the list
        List<Sighting> sightingList = sightingService.retrieveSightingByLocation(location, 2, 0);
    ...
    public void retrieveSightingByDatePage() {
        ...
        // Act
        List<Sighting> sightingList = sightingService.retrieveSightingByDate(date, 2, 0);
    ...
    public void retrieveSightingByDate() {
        ...
        // Act
        List<Sighting> sightingList = sightingService.retrieveSightingByDate(date, Integer.MAX_VALUE, 0);
