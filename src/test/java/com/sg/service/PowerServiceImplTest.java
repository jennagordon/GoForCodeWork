...
public class PowerServiceImplTest {
    ...
    public void updatePower() {
        ...
        // Act
        powerService.updatePower(readPower);
    ...
    public void retrieveAllPowers() {
        ...
        powerService.addPower(createdPower);

        // Act
        List<Power> powerList = powerService.retrieveAllPowers(Integer.MAX_VALUE, 0);
    ...
    public void retrievePowerByHeroPage() {
        ...
        // Act
        List<Power> powerList = powerService.retrievePowerByHero(hero, 2, 0);
