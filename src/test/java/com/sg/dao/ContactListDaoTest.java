...
public class ContactListDaoTest {
    ...
    public void setUp() throws Exception {
        ...
        List<Contact> contacts = dao.retrieveAllContacts();
    ...
    @Test
    public void addRetrieveDeleteContactTest() {
        Contact nc = new Contact();
        nc.setFirstName("John");
        nc.setLastName("Doe");
        nc.setCompany("Oracle");
        nc.setPhone("1234445678");
        nc.setEmail("john@does.com");

        dao.addContact(nc);
        Contact fromDb = dao.retrieveContactById(nc.getContactId());

        assertEquals(fromDb, nc);

        dao.removeContact(nc.getContactId());
        assertNull(dao.retrieveContactById(nc.getContactId()));
    }
    ...
    public void retrieveAllContacts() {
        ...
        List<Contact> cList = dao.retrieveAllContacts();
