...
public class HeroPowerDaoImplTest {
    ...
    public void removeHeroPower() {
        ...
        // Act
        heroPowerDao.removeHeroPower(createdHeroPower);
        HeroPower readHeroPower = heroPowerDao.retrieveHeroPowerById(createdHeroPower.getHeroPowerId());
    ...
    public void updateHeroPower() {
        ...
        // Act
        heroPowerDao.updateHeroPower(readHeroPower);
    ...
    public void retrieveHeroPowerByPower() {
        ...
        // Act
        List<HeroPower> readHP = heroPowerDao.retrieveHeroPowerByPower(power.getPowerId());
    ...
    public void retrieveHeroPowerByHero() {
        ...
        // Act
        List<HeroPower> readHP = heroPowerDao.retrieveHeroPowerByHero(hero.getHeroId());
    ...
    private HeroPower createTestHeroPower(Hero hero, Power power) {
        ...
        HeroPower createdHeroPower = heroPowerDao.addHeroPower(heroPower);
