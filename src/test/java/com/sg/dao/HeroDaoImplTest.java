...
public class HeroDaoImplTest {
    ...
    public void retrieveAllHero() {
        ...
        List<Hero> heroList = heroDao.retrieveAllHero(Integer.MAX_VALUE, 0);
    ...
    public void retrieveHero() {
        ...
        Hero readHero = heroDao.retrieveHero(createHero.getHeroId());
    ...
    public void retrieveHeroByPower() {
        ...
        Hero createdHero1 = heroDao.addHero(hero1);
        ...
        Hero createdHero2 = heroDao.addHero(hero2);
        ...
        Hero createdHero3 = heroDao.addHero(hero3);
        ...
        // Act
        // get the list back
        List<Hero> heroList = heroDao.retrieveHeroByPower(power, Integer.MAX_VALUE, 0);
    ...
    public void retrieveHeroesByPowerPage() {
        ...
        // Act
        List<Hero> heroList = heroDao.retrieveHeroByPower(power, 2, 0);
    ...
    public void retrieveHeroesBySightingPage() {
        ...
        // Act
        // get the list back
        List<Hero> heroList = heroDao.retrieveHeroBySighting(sighting, 2, 0);
    ...
    public void retrieveHeroBySighting() {
        ...
        // Act
        // get the list back
        List<Hero> heroList = heroDao.retrieveHeroBySighting(sighting, Integer.MAX_VALUE, 0);
    ...
    public void retrieveHeroesByOrganizationPage() {
        ...
        // Act
        // get the list back
        List<Hero> heroList = heroDao.retrieveHeroByOrganization(organization, 2, 0);
    ...
    public void retrieveHeroByOrganization() {
        ...
        // Act
        // get the list back
        List<Hero> heroList = heroDao.retrieveHeroByOrganization(organization, Integer.MAX_VALUE, 0);
    ...
    private Hero createTestHero() {
        ...
        Hero createdHero = heroDao.addHero(hero);
