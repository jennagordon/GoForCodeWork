...
public class HeroSightingDaoImplTest {
    ...
    public void removeHeroSighting() {
        ...
        // Act
        heroSightingDao.removeHeroSighting(createdHeroSighting);
        HeroSighting readHeroSighting = heroSightingDao.retrieveHeroSightingById(createdHeroSighting.getHeroSightingId());
    ...
    public void updateHeroSighting() {
        ...
        // Act
        heroSightingDao.updateHeroSighting(readHeroSighting);
    ...
    public void retrieveHeroSightingBySighting() {
        ...
        // Act
        List<HeroSighting> readHS = heroSightingDao.retrieveHeroSightingBySighting(sighting.getSightingId());
    ...
    public void retrieveHeroSightingByHero() {
        ...
        // Act
        List<HeroSighting> readHS = heroSightingDao.retrieveHeroSightingByHero(hero.getHeroId());
    ...
    private HeroSighting createTestHeroSighting(Hero hero, Sighting sighting) {
        ...
        HeroSighting createdHeroSighting = heroSightingDao.addHeroSighting(heroSighting);
