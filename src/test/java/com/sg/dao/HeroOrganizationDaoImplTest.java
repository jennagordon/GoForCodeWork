...
public class HeroOrganizationDaoImplTest {
    ...
    public void updateHeroOrganization() {
        ...
        // Act
        heroOrganizationDao.updateHeroOrganization(readHeroOrganization);
    ...
    public void retrieveHeroOrganizationByOrganization() {
        ...
        // Act
        List<HeroOrganization> heroOrgs = heroOrganizationDao.retrieveHeroOrganizationByOrganization(organization.getOrganizationId());
    ...
    public void retrieveHeroOrganizationByHero() {
        ...
        // Act
        List<HeroOrganization> heroOrgs = heroOrganizationDao.retrieveHeroOrganizationByHero(hero.getHeroId());
    ...
    private HeroOrganization createTestHeroOrganization(Hero hero, Organization organization) {
        ...
        HeroOrganization createdHeroOrganization = heroOrganizationDao.addHeroOrganization(heroOrganization);
