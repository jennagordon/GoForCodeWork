...
public class ContactController {
    ...
    public String displayContactsPage(Model model) {
        ...
        List<Contact> contactList = dao.retrieveAllContacts();
    ...
    public String displayContactDetails(HttpServletRequest request, Model model) {
        ...
        Contact contact = dao.retrieveContactById(contactId);
    ...
    public String deleteContact(HttpServletRequest request) {
        ...
        // redirects so the updated MyContacts table can be displayed
        return "redirect:displayContactsPage";
    }
